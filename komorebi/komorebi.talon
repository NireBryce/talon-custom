...
wendy tack left:            user.komorebic("cycle-stack left")
wendy tack right:           user.komorebic("cycle-stack right")
wendy tack up:              user.komorebic("cycle-stack up")
wendy tack down:            user.komorebic("cycle-stack down")
